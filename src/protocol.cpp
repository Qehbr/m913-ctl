...
// -----------------------------------------------------------------------
// Configuration read-back codes (see the comment in protocol.h)
// -----------------------------------------------------------------------

const std::array<Packet, M913_READ_CODE_COUNT> M913_READ_CODES = {{
    // session open / handshake / setup — not reads
    ...
    // reads: bytes[3..4] = address, byte[5] = 0x0a (10-byte chunk)
    ...
    // commit — the same packet a write session ends with
